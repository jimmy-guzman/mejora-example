...
export class NotificationService {
  ...
  createNotification(userId: number, title, message: string, type: NotificationType): Notification {
  ...
  getUnreadCount(userId: number): number {
    const allNotifications = this.notifications.filter(n => n.userId === userId);
